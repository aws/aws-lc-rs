...
#[test]
fn test_quic_aes_256_gcm() -> Result<(), error::Unspecified> {
    ...
    let key = quic::HeaderProtectionKey::new(&quic::AES_256, &key_bytes)?;
...
#[test]
fn test_quic_chacha20() -> Result<(), error::Unspecified> {
    ...
    let key = quic::HeaderProtectionKey::new(&quic::CHACHA20, &key_bytes)?;
