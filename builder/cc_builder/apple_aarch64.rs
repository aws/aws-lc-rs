...
// Mon Aug 31 21:36:05 UTC 2026

pub(super) const CRYPTO_LIBRARY: &[&str] = &[
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_intt_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_ntt_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_pointwise_montgomery_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_polyvecl_pointwise_acc_montgomery_l4_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_polyvecl_pointwise_acc_montgomery_l5_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_polyvecl_pointwise_acc_montgomery_l7_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_polyz_unpack_17_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_polyz_unpack_19_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_poly_caddq_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_poly_chknorm_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_poly_decompose_32_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_poly_decompose_88_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_poly_use_hint_32_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_poly_use_hint_88_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_rej_uniform_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_rej_uniform_eta2_aarch64_asm.S",
    "crypto/fipsmodule/ml_dsa/mldsa/native/aarch64/src/mldsa_rej_uniform_eta4_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_intt_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_ntt_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_polyvec_basemul_acc_montgomery_cached_k2_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_polyvec_basemul_acc_montgomery_cached_k3_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_polyvec_basemul_acc_montgomery_cached_k4_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_poly_mulcache_compute_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_poly_reduce_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_poly_tobytes_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_poly_tomont_aarch64_asm.S",
    "crypto/fipsmodule/ml_kem/mlkem/native/aarch64/src/mlkem_rej_uniform_aarch64_asm.S",
