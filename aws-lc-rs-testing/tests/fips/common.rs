...
macro_rules! assert_fips_status_indicator {
    ...
    ($function:expr, $expect:path, $message:literal) => {{
        match aws_lc_rs::check_fips_service_status!($function) {
            $expect(v) => v,
            _ => panic!($message),
        }
    }};
...
pub static TEST_P256_PUBLIC_BYTES: [u8; 65] = [
...
pub static TEST_MESSGAE_P256_SHA384_ASN1: [u8; 71] = [
...
// Only needed if you need to add additional test cases for signature verifications
#[allow(dead_code)]
pub static TEST_P384_PRIVATE_DER: [u8; 167] = [
...
pub static TEST_P384_PUBLIC_BYTES: [u8; 97] = [
...
pub static TEST_MESSAGE_P384_SHA256_ASN1: [u8; 102] = [
...
#[allow(dead_code)]
pub static TEST_RSA_1024_PRIVATE_PKCS8_DER: [u8; 635] = [
...
pub static TEST_RSA_1024_PUBLIC_BYTES: [u8; 140] = [
...
pub static TEST_RSA_2048_PRIVATE_PKCS8_DER: [u8; 1216] = [
...
pub static TEST_RSA_3072_PRIVATE_PKCS8_DER: [u8; 1793] = [
...
pub static TEST_RSA_4096_PRIVATE_PKCS8_DER: [u8; 2374] = [
...
pub static TEST_RSA_8192_PRIVATE_PKCS8_DER: [u8; 4679] = [
...
pub static TEST_MESSAGE_RSA_PKCS1_1024_SHA1: [u8; 128] = [
...
pub static TEST_MESSAGE_RSA_PKCS1_1024_SHA256: [u8; 128] = [
...
#[allow(dead_code)]
pub static TEST_MESSAGE_RSA_PKCS1_1024_SHA384: [u8; 128] = [
...
pub static TEST_MESSAGE_RSA_PKCS1_1024_SHA512: [u8; 128] = [
