...
pub(crate) enum AeadCtx {
    ...
    XAES_256_GCM(LcPtr<EVP_AEAD_CTX>),
...
impl AeadCtx {
    ...
    pub(crate) fn xaes_256_gcm(key_bytes: &[u8], tag_len: usize) -> Result<Self, Unspecified> {
        Ok(AeadCtx::XAES_256_GCM(AeadCtx::aes_256_context(
            EVP_aead_xaes_256_gcm,
            key_bytes,
            tag_len,
            None,
        )?))
