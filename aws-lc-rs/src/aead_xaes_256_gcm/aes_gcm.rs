...
use crate::aead_xaes_256_gcm::{Algorithm, AlgorithmID};

use crate::aead_xaes_256_gcm::aead_ctx::AeadCtx;
...
/// AES-256 in GCM mode with CMAC-based KDF, 128-bit tags and 160-bit to 192-bit nonces.
pub const XAES_256_GCM: Algorithm = Algorithm {
    init: init_256_aead_xaes,
    key_len: AES_256_KEY_LEN,
    id: AlgorithmID::XAES_256_GCM,
    max_input_len: u64::MAX,
};
...
#[inline]
fn init_256_aead_xaes(key: &[u8], tag_len: usize) -> Result<AeadCtx, Unspecified> {
    AeadCtx::xaes_256_gcm(key, tag_len)
}
