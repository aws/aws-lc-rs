...
fn test_serialized_agreement_kyber512() {
    ...
    let retrieved_pub_key = KemPublicKey::from_raw_bytes(Algorithm::KYBER512_R3, pub_key_bytes).unwrap();
    ...
    let retrieved_priv_key = KemPrivateKey::from_raw_bytes(Algorithm::KYBER512_R3, privkey_raw_bytes).unwrap();
