...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_new"]
    pub fn sk_new(comp: OPENSSL_sk_cmp_func) -> *mut _STACK;
}
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_new_null"]
    pub fn sk_new_null() -> *mut _STACK;
}
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_num"]
    pub fn sk_num(sk: *const _STACK) -> usize;
}
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_zero"]
    pub fn sk_zero(sk: *mut _STACK);
}
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_value"]
    pub fn sk_value(sk: *const _STACK, i: usize) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_set"]
    pub fn sk_set(
        sk: *mut _STACK,
        i: usize,
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_free"]
    pub fn sk_free(sk: *mut _STACK);
}
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_pop_free_ex"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_delete_if"]
    pub fn sk_delete_if(
        sk: *mut _STACK,
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_11_0_sk_find"]
    pub fn sk_find(
        sk: *const _STACK,
        out_index: *mut usize,
        p: *const ::std::os::raw::c_void,
