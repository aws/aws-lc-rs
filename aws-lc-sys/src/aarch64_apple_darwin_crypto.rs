...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_28_0_armv8_disable_dit"]
    pub fn armv8_disable_dit();
}
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_28_0_armv8_enable_dit"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_28_0_RAND_enable_fork_unsafe_buffering"]
