...
pub const AWSLC_VERSION_NUMBER_STRING: &[u8; 7] = b"1.25.0\0";
...
pub const OPENSSL_VERSION_TEXT: &[u8; 42] = b"OpenSSL 1.1.1 (compatible; AWS-LC 1.25.0)\0";
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_16_0_X509_VERIFY_PARAM_get0_peername"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_16_0_X509_VERIFY_PARAM_lookup"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_16_0_X509V3_EXT_val_prn"]
