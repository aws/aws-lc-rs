...
extern "C" {
    #[link_name = "\u{1}aws_lc_0_5_0_allow_rsa_keys_d_gt_n"]
...
extern "C" {
    #[link_name = "\u{1}aws_lc_0_5_0_TRUST_TOKEN_ISSUER_redeem_raw"]
...
extern "C" {
    #[link_name = "\u{1}aws_lc_0_5_0_GENERAL_NAME_cmp"]
...
extern "C" {
    #[link_name = "\u{1}aws_lc_0_5_0_OTHERNAME_cmp"]
